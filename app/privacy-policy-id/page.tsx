  ...
  return (
    <div className="max-w-4xl mx-auto my-10 p-6 bg-white rounded-xl shadow-md text-gray-800">
      ...
      <div className="mb-6 flex items-center justify-between">
        <Link
          href="/"
          className="text-custom-merah hover:text-red-700 gap-1 transition flex items-center"
        >
      ...
      <p>
        ...
        Pembaruan akan diposting di halaman ini dengan &ldquo;Tanggal
        Berlaku&ldquo; yang direvisi. Kami mendorong Anda untuk meninjau
